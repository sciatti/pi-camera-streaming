...
def basic_sigma_delta_update(I_t, M_t, V_t, V_max):
...
def conditional_sigma_delta_update(I_t, M_t, V_t, E_t, V_max):
...
def zipfian_sigma_delta_update(I_t, M_t, V_t, E_t, t, m, T_v, V_max):
    """A conditional sigma delta background subtraction algorithm"""
