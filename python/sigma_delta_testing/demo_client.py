...
import numpy as np
import cv2
from sigma_delta_est import zipfian_sigma_delta_update, basic_sigma_delta_update
...
def socket_driver():
    ...
    try:
        while True:
            ...
            cv2.imshow('energy', energy_image)
...
def zipfian_sigma_delta_driver(frame, count, E_t, M_t, V_t, m, T_v, arrType):
    ...
    return basic_sigma_delta_update(frame, M_t, V_t, arrType)
